...
{
	AddResource(L"Resources/Textures/TridentLogo.png", TEXTURE2D::TRIDENTLOGO);
	AddResource(L"Resources/Textures/Window.png", TEXTURE2D::WINDOW);
	AddResource(L"Resources/Textures/Arrow.png", TEXTURE2D::ARROW);
	...
	AddResource(L"Resources/Textures/donsoku.png", TEXTURE2D::DONSOKU);
	AddResource(L"Resources/Textures/fire.png", TEXTURE2D::HI);
	AddResource(L"Resources/Textures/niku.png", TEXTURE2D::NIKU);
