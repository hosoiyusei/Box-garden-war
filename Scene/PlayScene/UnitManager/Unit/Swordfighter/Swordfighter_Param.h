...
#pragma region constant
	...
	//通常時の件の回転角
	const float mRotation_angle_in_normal_sword;
	...
	//攻撃開始時の剣の回転角
	const float mSword_rotation_angle_at_attack_start;
	...
	//攻撃時の右手の移動
	const DirectX::SimpleMath::Vector3 mRight_hand_move_at_attack;

	//攻撃時の剣の回転
	const float mSword_rotation_at_attack;
...
#pragma endregion
	...
	Swordfighter_Param()
		...
		, mNormal_when_left_hand_coordinate(0.0f, -0.4f, 0.5f)
		, mNormal_when_right_hand_coordinate(0.0f, -0.4f, -0.5f)
		, mLeft_hand_coordinate_at_attack_start(-0.5f, 0.3f, 0.0f)
		, mRight_hand_coordinate_at_attack_start(-0.5f, 0.3f, 0.0f)
		, mSword_rotation_angle_at_attack_start(-0.2f)
		, mAttack_animation_time(15)
		, mLeft_hand_move_at_attack(0.0f, 0.06f, 0.0f)
		, mRight_hand_move_at_attack(0.0f, 0.06f, 0.0f)
		, mSword_rotation_at_attack(-5.5f)
		...
		, mHit_test_size(0.5f)
		, mRotation_angle_in_normal_sword(-60.0f)
	{
